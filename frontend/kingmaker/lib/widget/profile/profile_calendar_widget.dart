    ...
    return Container(
      ...
      child: TableCalendar(
        ...
        onPageChanged: (focusedDay) async {
          int? memberId = Provider.of<MemberProvider>(context, listen: false)
              .member
              ?.memberId;
          await Provider.of<CalendarProvider>(context, listen: false)
              .getMyCal(memberId!, focusedDay.year, focusedDay.month);
        ...
        headerStyle: HeaderStyle(
          ...
          leftChevronIcon:
              SvgPicture.asset('assets/icon/ic_left.svg', height: 24),
          rightChevronIcon:
              SvgPicture.asset('assets/icon/ic_right.svg', height: 24),
        ),
        calendarBuilders: CalendarBuilders(
          todayBuilder: (context, day, focusedDay) {
            int rate = levels['${day.day}']!.toInt();
            return Container(
                  ...
                  Center(
                    child: Container(
                      ...
                      child: SingleAnimatedStackCircularProgressBar(
                        ...
                        barColor: BLUE_COLOR,
                        barValue: rate.toDouble(),
                        isTextShow: false,
                      ),
                    ),
                  ),
                  Center(child: Text(day.day.toString(), style: TextStyle(color: DARKER_BLUE_COLOR),)),
                ],
              ),
            );
          },
          ...
          defaultBuilder: (context, day, focusedDay) {
            ...
            return Container(
              ...
              child: Stack(
                children: [
                  Center(
                    child: day.day < DateTime.now().day ? Container(
                      width: 36,
                      height: 36,
                      child: SingleAnimatedStackCircularProgressBar(
                        size: 200,
        ...
        calendarStyle: const CalendarStyle(
          todayDecoration: BoxDecoration(
              ...
              border: Border(
                  left: BorderSide(width: 1, color: Color(0xFF9FC6D2)),
                  top: BorderSide(width: 1, color: Color(0xFF9FC6D2)))),
